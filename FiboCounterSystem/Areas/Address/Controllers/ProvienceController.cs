...
namespace FiboCounterSystem.Areas.Address.Controllers
{
    public class ProvienceController : Controller
    {
        ...
        public ProvienceController(IProvienceService provienceService, IProvienceRepository provienceRepository, IProvienceAssembler provienceAssembler, IUserAndBranchInfo userAndBranchInfo)
        {
