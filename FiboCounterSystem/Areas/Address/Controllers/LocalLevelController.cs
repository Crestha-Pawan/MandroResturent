...
namespace FiboCounterSystem.Areas.Address.Controllers
{
    public class LocalLevelController : Controller
    {
        ...
        public LocalLevelController(ILocalLevelService localLevelService, ILocalLevelRepository localLevelRepository , ILocalLevelAssembler localLevelAssembler, IDistrictRepository districtRepository , IUserAndBranchInfo userAndBranchInfo)
        {
