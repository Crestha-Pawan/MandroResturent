...
namespace BusManagementAccountingSystem.Areas.PartySetup.Controllers
{
        ...
        public async Task<IActionResult> Create(LedgerDto dto)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    return RedirectToAction("Index", "Ledger", new { message = "Ledger has been saved successfully." });
                }
                else
                {
        ...
        public async Task<IActionResult> DeleteConfirmed(Ledger ledger)
        {
            try
            {
                if (ledger != null)
                {
                    ...
                    return RedirectToAction("Index", "Ledger", new { message = "Ledger been Delete successfully." });
                }
            }
            catch (Exception ex)
            {
