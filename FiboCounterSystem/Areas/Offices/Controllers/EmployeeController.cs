...
namespace BusManagementAccountingSystem.Areas.Offices.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Index(EmployeeViewModel vm,string message)
        {
        ...
        public async Task<IActionResult> SalaryIndex(EmployeeViewModel vm)
        {
            vm.Employees = new List<Employee>();
            var employees = await _employeeRepository.GetAllEmployeeAsync();
            //vm.Employees = emp.Where(x => x.IsActive()).ToList();
            ...
            {
                employees = employees.Where(x => x.Name == vm.Name).ToList();
            }
            vm.Employees = employees;
            return View(vm);
        }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            EmployeeDto dto = new EmployeeDto
            {
                ...
                Branchs = await _branchRepo.GetAllBranchAsync(),
        ...
        public async Task<IActionResult> DeleteConfirmed(Employee emp)
        {
            try
            {
                if (emp != null)
                {
                    ...
                    return RedirectToAction("Index", "Employee", new { message = "Employee been Delete successfully." });
                }
            }
            catch (Exception ex)
            {
