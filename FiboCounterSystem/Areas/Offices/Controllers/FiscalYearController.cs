...
namespace FiboCounterSystem.Areas.Offices.Controllers
{
    public class FiscalYearController : Controller
    {
        ...
        public FiscalYearController(IFiscalYearRepository repo, IFiscalYearService fiscalYearService, IFiscalYearAssembler assembler, IUserAndBranchInfo userAndBranchInfo )
        {
            _repo = repo;
