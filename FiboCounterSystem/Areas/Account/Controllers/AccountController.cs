...
namespace FiboCounterSystem.Areas.Account.Controllers
{
    public class AccountController : Controller
    {
        ...
        [HttpGet()]
        [AllowAnonymous]
        public async Task<IActionResult> Register(RegisterViewModel vm, string messege)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                   ...
                   // };
                    ...
                    await _userManager.UpdateAsync(user);
                    return RedirectToAction("Login", "Account", new { messege = "The User" + model.UserName + "Account Has been created successfully." });
                }
                AddErrors(result);
            }
            return View(model);
